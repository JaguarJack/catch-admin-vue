...
import type { anyObject, schemaType } from '@/components/catchForm/config/commonType'
import { $schema, $formValues, $selectData, $formEvents, $initialValues } from '@/components/catchForm/config/symbol'
